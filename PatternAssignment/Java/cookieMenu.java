...
public CookieMenu()
{
    ...
    addItem("Cinnamon Oatmeal Swirl", "Our famous  giant oatmeal cookie infused with a cinnamon roll style swirl",
    true, 2.99);

    addItem("Dark Chocolate Chunk", "Soft chocolate cookie with chunky bits of dark chocolate",
    false, 1.99);

    addItem("Summer Day", "Chewy vanilla sugar cookie topped with lemon icing", 
    false, 1.99);
}
